    ...
    return (
        <div>
          <Router>
            <NavBar/>
            <Routes>
            <Route path='/' element={<News key='/' pageSize={12} country='us' category='general' />}></Route>
            ...
            <Route path='/technology' element={<News key='technology' pageSize={12} country='us' category='technology' />}></Route>            </Routes> 
            </Router>
        </div>
    )
  }
